...
if ($return) jsheader("index.php?load=baby_rx");
...
<form action="index.php?load=baby_rx.do" method="post" name="do_baby_rx" id="do_baby_rx" onSubmit="return validate_types(this);">
